...
class ConfigurationRouter {
    ...
    getRouter() {
        this.router.post("/configuration", (request, response) => __awaiter(this, void 0, void 0, function* () {
            yield this._configurationHandler.create(request.body);
            response.status(200);
        }));
        this.router.get("/configuration", (request, response) => __awaiter(this, void 0, void 0, function* () {
            response.json("hi");
        }));
        return this.router;
    }
